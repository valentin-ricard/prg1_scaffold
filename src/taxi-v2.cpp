...
int main() {
    ...
    int minutesDepart;
    int tempsCourse;
    float prixCourseJournee;  // prix des heures durant le jour
    float prixCourseNuit;     // prix des heures durant la nuit.
    float prixTotal;

    // On initialise cette variable, car la course peut ne pas passer par les chemins candides.
    int tempsCourseMatin = 0;
    int tempsCourseTarifJournee;
    int tempsCourseSoir = 0;

    int tempsCourseTarifNuit;

    int departEnMinutes;
    int ecartArriveeSoir;
    int ecartDepartMatin;
